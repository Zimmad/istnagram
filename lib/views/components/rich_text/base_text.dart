...
class BaseText {
  ...
  // bool get isLinkText => this is LinkText; /// to check if [BaseText] is [LinkText]. LinkText extends the BaseText class
  ...
  factory BaseText.link({
    ...
    return LinkText(text: text, onTapped: onTapped, style: style);
  }
}
